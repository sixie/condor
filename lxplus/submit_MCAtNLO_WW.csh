...
cd $workDir
set script=/home/sixie/condor/bin/runMCAtNLO_WW.csh
...
Notification            = Error
Executable              = $script
Arguments               = $neventsPerJob $i $label $RScale $FScale $IL1 $IL2
Rank                    = Mips
...
EOF
    ...
    rm submit.cmd
    echo $script $neventsPerJob $i $label $RScale $FScale $IL1 $IL2
