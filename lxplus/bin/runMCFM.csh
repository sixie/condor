...
set workdir=/tmp/sixie
mkdir -p $workdir
cd $workdir

cp /home/sixie/MCGenerators/MCFMsend/MCFM_Pack.tgz ./
cp /home/sixie/MCGenerators/MCFMsend/input.${JetBin}.template.DAT ./
tar vxzf MCFM_Pack.tgz
